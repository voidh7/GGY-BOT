...
class SessionCipher {
    ...
    async decryptPreKeyWhisperMessage(data) {
        ...
        return await this.queueJob(async () => {
            ...
            if (!plaintext) {
                throw new errors.SessionError("Failed to decrypt message");
            }
    ...
    async doDecryptWhisperMessage(messageBuffer, session) {
        ...
        try {
            ...
            console.error("Falha ao preencher as chaves de mensagem", error);
            return null;
        }
        if (!chain.messageKeys.hasOwnProperty(message.counter)) {
            ...
            console.log("Chave já usada ou nunca preenchida");
            return null;
        }
        ...
        try {
            ...
            delete session.pendingPreKey;
            console.log("Falha ao verificar MAC, provavelmente sessão não corresponde. Ignorando...");
            return null;
        }
    }
    ...
    fillMessageKeys(chain, counter) {
        ...
        if (chain.chainKey.key === undefined) {
            console.log("Chave de cadeia indefinida");
            return;
        }
