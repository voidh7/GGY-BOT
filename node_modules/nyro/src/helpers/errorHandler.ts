...
export default class ErrorHandler extends Error {
    ...
    constructor(errorHandlerOptions: NyroErrorInterface) {
        ...
        this.message = errorHandlerOptions.message;
        this.name = 'NyroError';
        ...
        this.response = errorHandlerOptions.response;
        this.request = errorHandlerOptions.request;
        this.body = errorHandlerOptions.body;
