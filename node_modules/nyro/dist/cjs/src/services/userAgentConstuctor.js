...
exports.SafariVersions = exports.AndroidVersions = exports.ChromeVersions = void 0;
exports.getRandomVersion = getRandomVersion;
exports.generateChrome = generateChrome;
exports.generateFirefox = generateFirefox;
exports.generateSafari = generateSafari;
exports.generateAndroid = generateAndroid;
exports.generateEdge = generateEdge;
...
exports.ChromeVersions = chromeWebkitVersions;
...
exports.AndroidVersions = androidWebkitVersions;
...
exports.SafariVersions = safariWebkitVersions;
...
;
function generateChrome(version, os, device) {
    return "Mozilla/5.0 (".concat(os, ") AppleWebKit/537.36 (KHTML, like Gecko) Chrome/").concat(version !== null && version !== void 0 ? version : '537.36', " Safari/537.36");
}
function generateFirefox(version, os, device) {
    return "Mozilla/5.0 (".concat(os, "; rv:").concat(version !== null && version !== void 0 ? version : '537.36', ") Gecko/20100101 Firefox/").concat(version !== null && version !== void 0 ? version : '537.36');
}
function generateSafari(version, os, device) {
    return "Mozilla/5.0 (".concat(os, ") AppleWebKit/").concat(version !== null && version !== void 0 ? version : '604.1.28', " (KHTML, like Gecko) Version/").concat(version !== null && version !== void 0 ? version : '604.1.28', " Safari/").concat(version !== null && version !== void 0 ? version : '604.1.28');
}
function generateAndroid(version, device, buildVersion) {
    return "Mozilla/5.0 (Linux; Android ".concat(version !== null && version !== void 0 ? version : '537.36', "; ").concat(device, " Build/").concat(buildVersion !== null && buildVersion !== void 0 ? buildVersion : '537.36', ";) AppleWebKit/").concat(version !== null && version !== void 0 ? version : '537.36', " (KHTML, like Gecko) Version/4.0 Chrome/").concat(version !== null && version !== void 0 ? version : '537.36', " Mobile Safari/").concat(version !== null && version !== void 0 ? version : '537.36');
}
function generateEdge(version, os, device) {
    return "Mozilla/5.0 (".concat(os, ";) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/").concat(version, " Safari/537.36 Edge/").concat(version);
}
/**
...
var UserAgent = /** @class */ (function () {
    ...
    ;
    UserAgent.getVersion = function (os) {
        if (!os)
            os = this.getOS();
        switch (os) {
            case 'Windows':
    ...
    ;
    UserAgent.generate = function (options) {
        ...
        if (!options) {
            ...
            UserAgentOptions = {
                os: parseOS((options === null || options === void 0 ? void 0 : options.os) || 'Windows') || this.getOS(),
                browser: (options === null || options === void 0 ? void 0 : options.browser) || browser,
                device: (options === null || options === void 0 ? void 0 : options.device) || this.getDevice(),
                version: version
            };
        }
        ;
        ...
        var parsedOS = os == 'Windows' ?
            ...
            os == 'Mac OS' ?
                ...
                os == 'Linux' ?
                    ...
                    os == 'Android' ?
                        [
                            "Linux; Android 4.2.2; ".concat(UserAgentOptions.device),
                            "Linux; Android 4.4; ".concat(UserAgentOptions.device),
                            "Linux; Android 5.0; ".concat(UserAgentOptions.device),
                            "Linux; Android 5.1; ".concat(UserAgentOptions.device),
                            "Linux; Android 6.0; ".concat(UserAgentOptions.device),
                            "Linux; Android 7.0; ".concat(UserAgentOptions.device),
                            "Linux; Android 7.1; ".concat(UserAgentOptions.device),
                            "Linux; Android 8.0; ".concat(UserAgentOptions.device),
                            "Linux; Android 9.0; ".concat(UserAgentOptions.device),
                            "Linux; Android 10.0; ".concat(UserAgentOptions.device),
                            "Linux; Android 11.0; ".concat(UserAgentOptions.device),
                            "Linux; Android 12.0; ".concat(UserAgentOptions.device)
                        ]
                        :
                            os == 'iOS' ?
                                [
