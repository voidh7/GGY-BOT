...
* @async
*/
question(object:{model:"v3"|"v3-32k"|"turbo"|"turbo-16k"|"gemini"|"llama3-70b"|"llama3-8b"|"mixtral-8x7b"|"gemma-7b"|"gemma2-9b",content:string,personality?:string|""}):Promise<{content:string,reply:string,timestamp:{startTimestamp:number,endTimestamp:number}}>;
...
* @async
*/
 drawImage(object:{model:"v1"|"v2"|"v2-beta"|"v3"|"lexica"|"prodia"|"simurg"|"animefy"|"raava"|"shonin",prompt:string,negative_prompt?:string|""}):Promise<{model:string,prompt:string,url:string,timestamp:{startTimestamp:number,endTimestamp:number}}>;
 ...
 * @async
 */
betaQuestion(object:{content:string,user?:string|""}):Promise<{content:string,reply:string,timestamp:{startTimestamp:number,endTimestamp:number}}>;
...
* @async
*/
betaDrawImage(object:{prompt:string,negative_prompt?:string|"",sampler?:'DPM-Solver'|'SA-Solver',image_style?:"Cinematic"|"Photographic"|"Anime"|"Manga"|"Digital Art"|"Pixel art"| "Fantasy art"|"Neonpunk"|"3D Model"|"Null",width?:number,height?:number,steps?:number,scale?:number}):Promise<{model:string,prompt:string,url:string,timestamp:{startTimestamp:number,endTimestamp:number}}>;
